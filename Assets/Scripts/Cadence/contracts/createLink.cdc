...
import ExampleToken from 0x91c7fd71eaa35f2f
...
transaction {
  prepare(acct: AuthAccount) {
    ...
    //
    acct.link<&ExampleToken.Vault{ExampleToken.Receiver, ExampleToken.Balance}>(/public/CadenceFungibleTokenReceiver, target: /storage/CadenceFungibleTokenVault)
  ...
  post {
    ...
    getAccount(0x91c7fd71eaa35f2f).getCapability<&ExampleToken.Vault{ExampleToken.Receiver}>(/public/CadenceFungibleTokenReceiver)
                    .check():
