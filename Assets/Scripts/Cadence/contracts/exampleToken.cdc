...
pub contract ExampleToken {
    ...
    init() {
        ...
        self.account.save(<-create VaultMinter(), to: /storage/CadenceFungibleTokenMinter)
        ...
        self.account.link<&VaultMinter>(/private/Minter, target: /storage/CadenceFungibleTokenMinter)
    }
}
